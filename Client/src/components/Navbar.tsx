...
const Navbar: React.FC = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      await axios.post(
        "https://codsoft-e-commerce-website-nine.vercel.app/auth/logout",
        {},
        {
          headers: {
        ...
        <div className="flex items-center space-x-4 justify-center">
          <div className="flex items-center space-x-4 relative">
            <div
              className={
                isMenuOpen
                  ? "absolute top-[2.6rem] z-20 right-[-5rem] flex  px-6 space-y-3 bg-gray-800 whitespace-nowrap py-5 rounded-md flex-col"
                  : "hidden lg:flex lg:space-x-3"
              }
            >
              <Link
                to="/"
